...
<script type="text/javascript" src="/static/js/beautiful-select.js"></script>
...
<body>
<div id="header" style="background:39% 53% no-repeat url('/static/img/logo_new.png'); margin-top:-5px;">
    <ul>
                    ...
                    <tr>
                        <td class="searchbar-select">
                            <div class="beautiful-select" style="display:none;">
                                <span class="bs-label"><a href="#">寻物信息</a></span>
                                <ul class="bs-list bs-list-close">
                        ...
                        <td class="searchbar-text">
                            <input type="text" value="搜索您丢失或捡到的物品" name="sslr" id="search-text" />
                        </td>
